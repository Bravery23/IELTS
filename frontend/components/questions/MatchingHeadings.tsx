...
export default function MatchingHeadings({ questions }: Props) {
  const { userAnswers, setAnswer, isSubmitted } = useExamStore();

  // Options are the heading choices (e.g., "i. The importance of...")
  const headingOptions = questions[0]?.options || [];
